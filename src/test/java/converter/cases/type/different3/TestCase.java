...
public class TestCase {
    ...
    @Test
    public void testDifferentTypes3() {
        Source source = new Source();
        converter.cases.object2primitive.Source source1 = new converter.cases.object2primitive.Source();
        ...
        try {
            ...
            assertEquals(source.source1.getBoolean1(), target.source1.isBoolean1());
